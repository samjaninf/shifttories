...
*/
if("undefined"===typeof akeeba)var akeeba={};"undefined"===typeof akeeba.Transfer&&(akeeba.Transfer={lastUrl:"",lastResult:"",FtpBrowser:{params:{}},SftpBrowser:{params:{}},FtpTest:{},SftpTest:{},FtpModal:null,URLs:{},translations:{}});
...
"none";"manual"!=a&&(document.getElementById("akeeba-transfer-ftp-host").parentNode.parentNode.style.display="grid",document.getElementById("akeeba-transfer-ftp-port").parentNode.parentNode.style.display="grid",document.getElementById("akeeba-transfer-ftp-username").parentNode.parentNode.style.display="grid",document.getElementById("akeeba-transfer-ftp-password").parentNode.parentNode.style.display="grid",document.getElementById("akeeba-transfer-ftp-directory").parentNode.parentNode.parentNode.style.display=
...
"grid",document.getElementById("akeeba-transfer-ftp-privatekey").parentNode.parentNode.style.display="grid"}};
...
"none";document.getElementById("akeeba-transfer-ftp-passive-container").style.display="none";document.getElementById("akeeba-transfer-ftp-passive-fix-container").style.display="none";var a=document.getElementById("akeeba-transfer-ftp-method"),a=a.options[a.selectedIndex].value;"manual"==a?(document.getElementById("akeeba-transfer-btn-apply").parentNode.style.display="none",document.getElementById("akeeba-transfer-manualtransfer").style.display="grid"):(a={task:"applyConnection",method:a,host:document.getElementById("akeeba-transfer-ftp-host").value,
...
a=document.getElementById("akeeba-transfer-ftp-error");document.getElementById("akeeba-transfer-ftp-error-body").textContent=akeeba.Transfer.translations.COM_AKEEBA_CONFIG_DIRECTFTP_TEST_FAIL;a.style.display="block";akeeba.System.triggerEvent(a,"focus");akeeba.Transfer.onTransferMethodChange()},!1,15E3))};
